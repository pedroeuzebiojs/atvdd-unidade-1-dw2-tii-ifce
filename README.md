...
<p align="center">
  <img src="./assets/preview-mobile.png" alt="Visualização do projeto Calculadora Básica em Mobile" align="center" width="400" />
</p>
...
```bash
git clone https://github.com/pedroeuzebiojs/atvdd-unidade-1-dw2-tii-ifce
```
...
```bash
cd atvdd-unidade-1-dw2-tii-ifce
```
...
- [Exibir projeto](https://pedroeuzebiojs.github.io/atvdd-unidade-1-dw2-tii-ifce)
